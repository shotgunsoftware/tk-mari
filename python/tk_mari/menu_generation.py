...
class ActionFactory(object):
    ...
    def create_action(self, name, callback):
        ...
        callback_string = "mari.%s[%d]()" % (
            ActionFactory.ACTION_COMMANDS_ATTR,
            action_id,
        )
...
class MenuGenerator(object):
    ...
    def create_menu(self):
        ...
        shotgun_menu = "%s/%s" % (
            ...
            MenuGenerator.SHOTGUN_MENU_ROOT,
        )
    ...
    def destroy_menu(self):
        ...
        sub_menus = mari.menus.submenus(
            MenuGenerator.MAIN_MENU_SET, MenuGenerator.SHOTGUN_MENU_ROOT
        )
        for sm in sub_menus:
            actions = mari.menus.actions(
                MenuGenerator.MAIN_MENU_SET, MenuGenerator.SHOTGUN_MENU_ROOT, sm
            )
            for action in actions:
                mari.menus.removeAction(
                    "%s/%s/%s/%s"
                    % (
                        MenuGenerator.MAIN_MENU_SET,
                        MenuGenerator.SHOTGUN_MENU_ROOT,
